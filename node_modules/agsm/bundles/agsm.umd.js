(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('agsm', ['exports', '@angular/core', 'rxjs', 'rxjs/operators'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.agsm = {}, global.ng.core, global.rxjs, global.rxjs.operators));
    ...
    ***************************************************************************** */
    ...
    var AgsmService = /** @class */ (function () {
        function AgsmService() {
            var _this = this;
            this.store = {};
            this.id = 0;
            this.devToolsId = function () { return "agsm" + (Date.now().toString(36) + Math.random().toString(36).substr(2)) + "-dispatch" + _this.id++; };
            this.devToolsLink = false;
            /* For future use */
            this.stateMap = {};
            this.actionMap = {};
            this._store = new rxjs.BehaviorSubject({});
        }
        /**
         ...
         * @returns void
         */
        AgsmService.prototype.addReducer = function (reducerName, reducerFunc) {
            if (this.store[reducerName]) {
                throw new Error('Cannot have duplicate reducer names in store.');
            }
            var initialState = reducerFunc({ type: 'AGSM_INIT', payload: {} });
            ...
            this.store[reducerName] = {
                ...
                state: initialState,
                reducer: new rxjs.BehaviorSubject(initialState),
            };
        };
        /**
         ...
         * @returns void
         */
        AgsmService.prototype.dispatch = function (actionType, payload) {
            var e_1, _a, e_2, _b;
            var action = {
                type: actionType,
            ...
            try {
                ...
                for (var _c = __values(Object.keys(this.store)), _d = _c.next(); !_d.done; _d = _c.next()) {
                    var key = _d.value;
                    var oldState = this.store[key].state; // For performance reasons
                    ...
                    var equals = true;
                    try {
                        for (var _e = (e_2 = void 0, __values(Object.keys(this.store[key].state))), _f = _e.next(); !_f.done; _f = _e.next()) {
                            var _key = _f.value;
         ...
         * @returns Observable
         */
        AgsmService.prototype.stateSelector = function (selector) {
            var selectedState = selector(this.store);
            if (!selectedState)
                throw new Error('Selected reducer does not exist in agsm store');
            return selectedState.reducer.asObservable().pipe(operators.map(function (state) {
         ...
         * @returns void
         */
        AgsmService.prototype.setStoreInitialState = function (state) {
            var e_3, _a;
         ...
         * @returns void
         */
        AgsmService.prototype.linkDevTools = function (activate) {
            this.devToolsLink = activate;
        };
        return AgsmService;
    }());
    AgsmService.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: AgsmService, deps: [], target: i0__namespace.ɵɵFactoryTarget.Injectable });
    AgsmService.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: AgsmService, providedIn: 'root' });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: AgsmService, decorators: [{
                type: i0.Injectable,
                args: [{
                        providedIn: 'root',
                    }]
    ...
    exports.AgsmService = AgsmService;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=agsm.umd.js.map
